...
//            intersect.MaterialType = 0;
            ...
            SMaterial sphereMaterial = materials[sphere.MaterialIdx];
            intersect.Color = sphereMaterial.Color;
            intersect.LightCoeffs = sphereMaterial.LightCoeffs;
            intersect.ReflectionCoef = sphereMaterial.ReflectionCoef;
            intersect.RefractionCoef = sphereMaterial.RefractionCoef;
            intersect.MaterialType = sphereMaterial.MaterialType;
            result = true;
        }
    }
    ...
    for(int i = 0; i < 10; i++) {
        ...
        && test < intersect.Time) {
            ...
            SMaterial triangleMaterial = materials[triangle.MaterialIdx];

            intersect.Color = triangleMaterial.Color;
            intersect.LightCoeffs = triangleMaterial.LightCoeffs;
            intersect.ReflectionCoef = triangleMaterial.ReflectionCoef;
            intersect.RefractionCoef = triangleMaterial.RefractionCoef;
            intersect.MaterialType = triangleMaterial.MaterialType;
            result = true;
        }
    }
    return result;
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[6]) {
    ...
    materials[0].Color = vec3(0.05, 0.85, 0.31);
    ...
    materials[2].ReflectionCoef = 1.0;
    materials[2].RefractionCoef = 1.0;
    materials[2].MaterialType = REFLECTION;

    materials[3].Color = vec3(0.55, 0.827, 0.9);
    ...
    materials[4].Color = vec3(0.88, 0.98, 0.45);
    ...
    materials[5].Color = vec3(0.35, 0.368, 0.678);
